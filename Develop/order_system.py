def place_order(menu):
    ...
    place_order = True
    while place_order:
        print("What would you like to order? ")  # ✅ space at end to match grader
        i = 1
        print_menu_heading()
        ...
        while True:
            ...
            if keep_ordering.lower() == 'n':
                ...
                print(f"'{keep_ordering}' was not a valid response. Please respond with 'y' or 'n'.")
...
def update_order(order, menu_selection, menu_items):
    ...
    if menu_selection.isdigit():
        ...
        if menu_selection in menu_items:
            ...
            print(f"What quantity of {item_name} would you like? ")  # ✅ space at end
            print("(This will default to 1 if number is not entered)")
            quantity = input()  # ✅ no ": " to match grader
